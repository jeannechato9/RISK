	 ...
	 public void update(GameContainer container) throws SlickException {
	  ...
	  public void render(GameContainer container, Graphics g) throws SlickException {
		  ...
		  if(nbre_joueurs==6) {
			  a=affichage_1( g, a, 0,  container,Armee_posees_joueur1);
				  if(Armee_posees_joueur1[0]!=0) {
					  render_armees_placees_joueur2(g, Armee_posees_joueur1);
			  }
		...
		if(Armee_posees_joueur3[0]!=0) {
				  render_armees_placees_joueur2(g, Armee_posees_joueur3);
		  }
		
		d=affichage_4( g, a, b, c, d, container, Armee_posees_joueur4);
		if(Armee_posees_joueur4[0]!=0) {
			  render_armees_placees_joueur2(g, Armee_posees_joueur4);
	  }
		  e=affichage_5( g, a, b, c, d, e, container, Armee_posees_joueur5);
		  if(Armee_posees_joueur5[0]!=0) {

			  render_armees_placees_joueur2(g, Armee_posees_joueur5);
	  }
		  f=affichage_6( g, a, b, c, d, e, f, container, Armee_posees_joueur6);
		  if(Armee_posees_joueur6[0]!=0) {
			  render_armees_placees_joueur2(g, Armee_posees_joueur6);
			  fin=true;
	  }
		  if(fin) {
			  g.drawString("Fin de l'initialisation", 500, 140);
		  }
		  ...
		  if(nbre_joueurs==5) {
			  ...
			  if(Armee_posees_joueur1_5[0]!=0) {
				  ...
				  render_armees_placees_joueur2(g, Armee_posees_joueur1_5);
		  }
		  ...
		  if(nbre_joueurs==4) {
			  ...
			  if(Armee_posees_joueur1_4[0]!=0) {
				  ...
				  render_armees_placees_joueur2(g, Armee_posees_joueur1_4);
		  }
			  ...
			  if(Armee_posees_joueur3_4[0]!=0) {
				  ...
				  render_armees_placees_joueur2(g, Armee_posees_joueur3_4);
		  }
			  d=affichage_4( g, a, b, c, d, container, Armee_posees_joueur4_4);
			  if(Armee_posees_joueur4_4[0]!=0) {

				  render_armees_placees_joueur2(g, Armee_posees_joueur4_4);
				  fin=true;
		  }
			  if(fin) {
				  g.drawString("Fin de l'initialisation", 500, 140);
		  ...
		  if(nbre_joueurs==3) {
			  ...
			  if(Armee_posees_joueur1_3[0]!=0) {
				  ...
				  render_armees_placees_joueur2(g, Armee_posees_joueur1_3);
		  }
			  ...
			  if(Armee_posees_joueur3_3[0]!=0) {
				  ...
				  render_armees_placees_joueur2(g, Armee_posees_joueur3_3);
				  fin=true;
		  }
			  if(fin) {
					  g.drawString("Fin de l'initialisation", 500, 140);
		  ...
		  if(nbre_joueurs==2) {
			  ...
			  if(Armee_posees_joueur1_2[0]!=0) {
				  ...
				  render_armees_placees_joueur2(g, Armee_posees_joueur1_2);
		  }
...
public void render_armees_placees_joueur1(Graphics g, int []Armee_posees_joueur1) {
	...
	for(int i = 0 ; i < Armee_posees_joueur1.length ; i++){
	 ...
	 if(map.containsKey(Armee_posees_joueur1[i])){
	  map.replace(Armee_posees_joueur1[i],map.get(Armee_posees_joueur1[i])+1);
	 }
	 // Sinon on l'ajoute
	 else{
	  map.put(Armee_posees_joueur1[i],1);
	 }
	}
	
	for(Integer key : map.keySet()){
		 g.setColor(Color.black);
		 g.drawString( Integer.toString(map.get(key)),Tableau_terr_x_debut[key-1], Tableau_terr_y_debut[key-1]);
		}
}
...
public void render_armees_placees_joueur2(Graphics g, int [] Armee_posees_joueur2) {
	...
	for(int i = 0 ; i < Armee_posees_joueur2.length ; i++){
	 // Si l'element existe deja, on remplace la valeur
	 if(map.containsKey(Armee_posees_joueur2[i])){
	  map.replace(Armee_posees_joueur2[i],map.get(Armee_posees_joueur2[i])+1);
	 }
	 // Sinon on l'ajoute
	 else{
	  map.put(Armee_posees_joueur2[i],1);
	 }
	}
